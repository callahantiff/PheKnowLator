...
* `resources/Master_Edge_List_Dict.json`_ ➞ *automatically during edge list construction*
* `resources/node_data/node_metadata_dict.pkl <https://github.com/callahantiff/PheKnowLator/blob/master/resources/node_data/README.md>`__ ➞ *if adding knowledge graph metadata*
