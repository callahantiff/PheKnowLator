...
def main():
    ...
    print('INPUT DOCUMENT BUILDER\n\nThis program will help you generate the input documentation needed to run '
          ...
          '\n\t\t\t3.The value (i.e., "int", "float", "str", "list") to filter on (e.g., "IEA" and "0.0001" in the '
          'example above);\n\t(9) Filtering criteria that can be used to filter an input data source (e.g., '
          'human proteins). An evidence set is composed of 3 pieces of ";"-separated information.\n\t\tMultiple '
