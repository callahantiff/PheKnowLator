...
__all__ = ['url_download', 'ftp_url_download', 'gzipped_ftp_url_download', 'zipped_url_download',
           ...
           'splits_knowledge_graph', 'finds_node_type', 'updates_graph_namespace', 'maps_node_ids_to_integers',
           'nt_serializes_node', 'appends_to_existing_file', 'converts_rdflib_to_networkx']
