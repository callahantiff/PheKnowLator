...
class TestMetadata(unittest.TestCase):
    ...
    def setUp(self):
        # (self, kg_version: str, flag: str, write_location: str, kg_location: str, node_data: Optional[List],
    ...
    def test_creates_node_metadata(self):
        ...
        # (self, node: str, edge_type: str, url: str, graph: Graph)
    ...
    def test_adds_node_metadata(self):
        ...
        # (self, graph: Graph, edge_dict: Optional[Dict])
